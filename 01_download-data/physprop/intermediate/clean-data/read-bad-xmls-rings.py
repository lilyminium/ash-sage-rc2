...
if __name__ == "__main__":
    ...
    # in this paper, mole fractions are specified by alcohol, not benzene/cyclohexane
    bad = df[df["Mole fraction compound"].isin(["benzene", "cyclohexane"])]
    bad.to_csv("bad-ring-data.csv")
