...
if __name__ == "__main__":
    ...
    df.to_csv("all-ester-data.csv")

    # in this paper, the esters are incorrectly specified, i.e. pentyl methanoate should be methyl methanoate
    # methyl methanoate is fine
    bad = df[df["Mole fraction compound"] != "methyl methanoate"]
    bad.to_csv("bad-ester-data.csv")
