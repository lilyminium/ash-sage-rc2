...
if __name__ == "__main__":
    ...
    df.to_csv("all-p-data.csv")

    # in this paper, mole fractions are specified by TBP
    bad = df[
        ["butan" in x for x in df["Mole fraction compound"]]
    ]
    bad.to_csv("bad-p-data.csv")
